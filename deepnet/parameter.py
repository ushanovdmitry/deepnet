...
import util
from util import ParameterOpts
...
class Parameter(object):
    def __init__(self):
        ...
        self.params = {}  # type: dict[str, cm.CUDAMatrix]

    def save_parameters(self):
        for param in self.proto.param:
            param.mat = util.NumpyAsParameter(self.params[param.name].asarray())

    def load_params(self, param_opts, t_op=None, tied_to=None):
        """
            :type param_opts: list[ParameterOpts]
        """
        ...
        for param in param_opts:
            ...
            if tied_to:
                ...
                if param.mat:
                    ...
                    mat = self.initialize_parameter(param)
